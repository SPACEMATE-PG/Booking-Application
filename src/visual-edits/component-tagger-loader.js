...
const fs = require("fs");   // ✅ ADDED — required for folder-skip logic
...
const threeFiberElems = [
    ...
    "meshToonMaterial","meshNormalMaterial","meshLambertMaterial","meshDepthMaterial",
    "meshDistanceMaterial","meshBasicMaterial","meshMatcapMaterial",
    "lineDashedMaterial","lineBasicMaterial","primitive","light","spotLightShadow",
    "spotLight","pointLight","rectAreaLight","hemisphereLight","directionalLightShadow",
    ...
    "directionalLightHelper","cameraHelper","boxHelper","box3Helper","planeHelper",
    "arrowHelper","axesHelper","texture","videoTexture","dataTexture","dataTexture3D",
    "compressedTexture","cubeTexture","canvasTexture","depthTexture","raycaster",
    "vector2","vector3","vector4","euler","matrix3","matrix4","quaternion",
    ...
    "uint32BufferAttribute","instancedBufferAttribute","color","fog","fogExp2","shape",
    "colorShiftMaterial"
];

const dreiElems = [
    "AsciiRenderer","Billboard","Clone","ComputedAttribute","Decal","Edges","Effects",
    "GradientTexture","MarchingCubes","Outlines","PositionalAudio","Sampler",
    ...
    "AdaptiveEvents","BakeShadows","Bvh","Detailed","Instances","Merged","meshBounds",
    "PerformanceMonitor","Points","Preload","Segments","Fisheye","Hud","Mask",
    ...
    "CubicBezierLine","Facemesh","Line","Mesh","QuadraticBezierLine","RoundedBox",
    "ScreenQuad","AccumulativeShadows","Backdrop","BBAnchor","Bounds","CameraShake",
    "Caustics","Center","Cloud","ContactShadows","Environment","Float","Lightformer",
    "MatcapTexture","NormalTexture","RandomizedLight","Resize","ShadowAlpha","Shadow",
    "Sky","Sparkles","SpotLightShadow","SpotLight","Stage","Stars","OrbitControls"
];
                ...
                for (const declarator of node.declarations) {
                    if (declarator.id.type === 'Identifier' && declarator.init) {
                        ...
                        variables.set(varName, {
                            ...
                            loc: (_a = declarator.loc) === null || _a === void 0
                                ? void 0
                                : _a.start
                        });
                    }
...
const findMapContext = (node, variables) => {
    ...
    while (current && depth < maxDepth) {
        if (
            ...
            ((_c = (_b = current.callee) === null || _b === void 0 ? void 0 : _b.property) === null
                || _c === void 0
                ? void 0
                : _c.name) === 'map'
        ) {
            const arrayName = (_d = current.callee.object) === null || _d === void 0
                ? void 0
                : _d.name;
            const mapCallback = (_e = current.arguments) === null || _e === void 0
                ? void 0
                : _e[0];

            if (arrayName && (mapCallback === null || mapCallback === void 0
                ? void 0
                : mapCallback.type) === 'ArrowFunctionExpression') {
                const itemParam = (_f = mapCallback.params) === null || _f === void 0
                    ? void 0
                    : _f[0];
                const indexParam = (_g = mapCallback.params) === null || _g === void 0
                    ? void 0
                    : _g[1];

                if ((itemParam === null || itemParam === void 0
                    ? void 0
                    ...
                    return {
                        ...
                        arrayItems: varInfo === null || varInfo === void 0
                            ? void 0
                            : varInfo.arrayItems,
                        arrayLoc: varInfo === null || varInfo === void 0
                            ? void 0
                            : varInfo.loc,
                        indexVarName:
...
function componentTagger(src, map) {
    ...
    try {
        // ✅ FIX: Prevent Turbopack crash on directories
        if (fs.existsSync(this.resourcePath) && fs.lstatSync(this.resourcePath).isDirectory()) {
            return done(null, src, map);
        }

        // ✅ FIX: Only process code files
        if (!/\.(jsx|tsx|js|ts)$/.test(this.resourcePath)) {
            return done(null, src, map);
        }
